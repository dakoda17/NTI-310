...
nslcd nslcd/ldap-uris string ldap://continue_ldap_install
...
ldap-auth-config ldap-auth-config/ldapns/ldap-server string ldap://continue_ldap_install/
...
sed -i 's,uri ldapi:///,uri ldap://continue_ldap_install/,g' /etc/ldap.conf
