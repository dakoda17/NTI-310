...
gcloud compute scp --zone us-east1-c $1.cfg koda@nagios4419:/etc/nagios/servers
...
gcloud compute ssh --zone us-east1-c koda@nagios4419 --command='sudo /usr/sbin/nagios -v /etc/nagios/nagios.cfg'
